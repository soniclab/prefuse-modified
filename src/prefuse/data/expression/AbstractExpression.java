    ...
    implements Expression, ExpressionListener
{
 ...
 //   public final void addExpressionListener(ExpressionListener lstnr) {     // original code
       public void addExpressionListener(ExpressionListener lstnr) {    // modified by Jinling

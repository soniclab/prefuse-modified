...
public class JSearchPanel extends JPanel
    implements FocusListener,DocumentListener, ActionListener
{
    private Object m_lock;
    private SearchTupleSet m_searcher;

    private JTextField m_queryF  = new JTextField(100);    // changed by Jinling. original code is "new JTextField(15)"
    private JLabel     m_resultL = new JLabel("          ");
    private JLabel     m_searchL = new JLabel("find >> ");
            ...
            String[] fields, boolean autoIndex, boolean monitorKeystrokes)
    {
      ...
      //  m_monitorKeys = monitorKeystrokes;
           m_monitorKeys = true;
        m_searcher = ( search != null ? search : new RegexSearchTupleSet() );
            ...
            String[] fields, boolean autoIndex, boolean monitorKeystrokes)
    {
        ...
        if ( search != null ) {
           ...
           m_searcher = new RegexSearchTupleSet();
    ...
    private void init(TupleSet source) {
        ...
        m_queryF.addFocusListener(this);
        if ( m_monitorKeys )
            m_queryF.getDocument().addDocumentListener(this);
        m_queryF.setMaximumSize(new Dimension(400, 100));
        m_queryF.setPreferredSize(new Dimension(400, 20));    //changed by Jinling. original code is" new Dimension(200, 20)"
    ...
    private void initUI() {
        ...
        m_sbox.setPreferredSize(new Dimension(371, 20));// changed by JInling. Original code is"new Dimension(171, 20)"
    ...
    protected void searchUpdate() {
         m_queryF.setBackground(Color.decode("0xA4D3EE"));
        ...
        synchronized ( m_lock ) {
             ...
             if(query.length() == 0)
                ...
                m_queryF.setBackground(Color.white);

            if(( m_searcher.getQuery().length() == 0 && m_searcher.getQuery() != "" ) ||  query.length() == 0){
